...
%   roll  : [Lp, tau_p]                          (2 params; Gamma1 fixed to 0)
%   pitch : [Mq, tau_q, Xu_m] off-hover          (3 params)
%           [Mq, tau_q]       at hover           (2 params; Xu_m not excited)
%   yaw   : [Nr, Gamma3, tau_r]                  (3 params)
%   heave : [Tmax_m, Zw_m, Zww_m]                (3 params)
%   lat   : [Yv_m, Yvv_m]                        (2 params)
%
% The full 16-parameter vector is assembled at the end by merging OE results
